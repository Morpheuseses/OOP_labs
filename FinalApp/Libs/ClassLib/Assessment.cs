...
public class Assessment : IInit, ICloneable, IComparable
{
    ...
    public Assessment()
    {
        ...
        CreateMarks(Student.CreateStudents());
    }
    ...
    public void CreateMarks(IEnumerable<Student> students)
    {
        var marks = new Dictionary<string, int?>();
        foreach (var student in students)
        {
            int grade = rand.Next(4);
            if (grade == 0)
                marks.Add(student.ToString(), 0);
            else
                marks.Add(student.ToString(), grade + 2);
        }
        this.Marks = marks;
    }
    ...
    public virtual object Clone()
    {
        ...
        newAssessment.Marks = new Dictionary<string, int?>(this.Marks);
